...
function Admin() {
  ...
  return (
    ...
    >
      <h3 style={{ color: '#7137ea', marginBottom: 14 }}>
        🛠 Quản lý góp ý ({feedbacks.length})
      </h3>
      {toast && (
        <div
          style={{
          ...
          feedbacks.map(fb => (
            ...
            >
              <div style={{ marginBottom: 4 }}>
                <b>Message:</b>{' '}
                <span style={{ color: '#222' }}>{fb.message}</span>
              </div>
              <div style={{ marginBottom: 4 }}>
                <b>Gợi ý trả lời:</b>{' '}
                <span style={{ color: '#24637c' }}>{fb.suggested_reply}</span>
              </div>
              <div style={{ marginBottom: 4 }}>
                <b>Giải thích:</b>{' '}
                <span style={{ color: '#999' }}>{fb.explanation || '---'}</span>
              </div>
              <div style={{ marginBottom: 4 }}>
                <b>Thời gian:</b>{' '}
              ...
              <div>
                ...
                <span
                  style={{
                    color: fb.approved ? '#44bd32' : '#f39c12',
                    fontWeight: 600,
                  }}
                >
